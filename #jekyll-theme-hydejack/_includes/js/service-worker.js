...
const SHELL_CACHE = "shell-9.1.5--{{ cache_version }}--{{ site_key }}";
...
// {% if google_fonts %}
const GOOGLE_FONTS = "{{ site.google_fonts_url | default:'https://fonts.googleapis.com' }}/css2?family={{ google_fonts | uri_escape }}&display=swap";
// {% endif %}

const SHELL_FILES = [
  "{{ '/assets/css/hydejack-9.1.5.css' | relative_url }}",
