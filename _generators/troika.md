...
<div class="troikaCharCard" id="charCard" style="display:none;">
  <p style="text-align:center;"><strong>Save your character</strong>: bookmark this page, <span id="saveCharacter">copy this link</span>, or <a onclick="window.print();return false;">print it out</a> (ctrl+p).</p>
  <div class="row">
