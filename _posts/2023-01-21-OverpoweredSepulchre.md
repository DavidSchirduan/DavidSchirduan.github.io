...
- Spends a <span class="d20">d20</span> and a <span class="d6">d6</span> to withstand the flames (16 damage).
- Spends a <span class="d8">d8</span> and a <span class="d6">d6</span> to melt through the door (difficulty of 6).
...
- Gains 1<span class="d8">d8</span> for entering a new area.
- Spends a <span class="d4">d4</span> and a <span class="d6">d6</span> to stun the kobold (4 HP).
- Gains 1<span class="d6">d6</span> for sampling a weak creature.
- Gains 6<span class="d4">d4</span> for 6 handfuls of treasure.
- Spends 1<span class="d4">d4</span> and 1<span class="d6">d6</span> to melt through the door (difficulty 4).
...
- Gains 1<span class="d8">d8</span> for entering a new area.
- Spends 2<span class="d4">d4</span>, 1<span class="d10">d10</span>, and 1<span class="d8">d8</span> to withstand the flames (16 damage).
...
- Spends 2<span class="d4">d4</span> melting through the door (rolled up a difficulty of 4).
- Gains 1<span class="d8">d8</span> for entering a new area.
- Spends 2<span class="d8">d8</span> and 1<span class="d10">d10</span> to outrun the ooze (movement of 10).
...
- Spends 1<span class="d10">d10</span> to melt the door (difficulty 8).
...
- Gains 1<span class="d8">d8</span> for entering a new area.
- Spends 3<span class="d4">d4</span> opening the sarcophagus (difficulty 6).
...
- Spend 1<span class="d12">d12</span>, 1<span class="d10">d10</span>, 1<span class="d8">d8</span> withstanding 18 damage from the skeleton's attacks (3 attacks, 6 damage each).
- Spend 4<span class="d4">d4</span>, 1<span class="d8">d8</span>, and 1<span class="d10">d10</span> melting through the door (difficulty 15).
