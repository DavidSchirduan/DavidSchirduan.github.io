...
Update the log logic
fix endgame, confirm submission screen
put rules in app
...
function renderOP(trib) {
  ...
  if (trib >= 30 && (freeSlots >= 3)) {
    ...
    document.getElementById('gainDiceButton').innerHTML = " <span style=\"color:var(--OPyellow)\">30</span> : GAIN d4 d6 d8 d10 d12 d20"
